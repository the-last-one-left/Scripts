<#
.SYNOPSIS
    Comprehensive SharePoint Online Security and Usage Report Tool v3
...
.NOTES
    Author: Pacific Office Automation - Escalations Team
    Version: 3.1
...
# Pacific Office Automation branding
$Script:Branding = @{
    PrimaryBlue   = "#00A0D9"
    White         = "#FFFFFF"
    Black         = "#000000"
    ...
    CompanyName   = "Pacific Office Automation"
}

# Chart colors for visualizations
$Script:ChartColors = @(
    "#00A0D9", "#007AB8", "#28a745", "#ffc107", "#dc3545", 
    "#6f42c1", "#20c997", "#fd7e14", "#6c757d", "#17a2b8",
    "#e83e8c", "#343a40", "#7952b3", "#4dabf5", "#51cf66"
)
...
<style>
:root { --poa-blue: #00A0D9; --poa-dark-blue: #007AB8; --poa-light-blue: #E6F7FF; }
* { margin: 0; padding: 0; box-sizing: border-box; }
body { font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background: #f5f5f5; color: #333; line-height: 1.6; }
.header { background: linear-gradient(135deg, var(--poa-blue), var(--poa-dark-blue)); color: #fff; padding: 25px 40px; display: flex; justify-content: space-between; align-items: center; }
...
.summary-card { background: white; border-radius: 8px; padding: 18px; box-shadow: 0 2px 6px rgba(0,0,0,0.08); border-left: 4px solid var(--poa-blue); }
.summary-card.warning { border-left-color: #f0ad4e; }
.summary-card.danger { border-left-color: #dc3545; }
.summary-card .value { font-size: 28px; font-weight: 600; color: var(--poa-blue); }
...
.section-header { background: var(--poa-light-blue); padding: 14px 20px; border-bottom: 2px solid var(--poa-blue); cursor: pointer; display: flex; justify-content: space-between; align-items: center; user-select: none; }
.section-header:hover { background: #d4f0ff; }
.section-header h2 { font-size: 16px; color: var(--poa-dark-blue); font-weight: 600; }
.section-header .count { background: var(--poa-blue); color: #fff; padding: 2px 10px; border-radius: 12px; font-size: 12px; }
...
th { background: #f8f9fa; padding: 10px 12px; text-align: left; font-weight: 600; color: var(--poa-dark-blue); border-bottom: 2px solid #dee2e6; position: sticky; top: 0; }
...
.progress-bar-fill { height: 100%; background: var(--poa-blue); }
...
.setting-value { font-weight: 600; color: var(--poa-dark-blue); }
.footer { text-align: center; padding: 20px; color: #666; font-size: 11px; }
.footer .tagline { color: var(--poa-blue); font-weight: 600; font-size: 13px; }
...
a { color: var(--poa-blue); text-decoration: none; }
...
<div style="flex:1;">
<div style="font-weight:600;font-size:13px;color:var(--poa-dark-blue);">
...
"@
        ...
        foreach ($folder in $library.Folders) {
            ...
            $barColor = if ($pctOfLibrary -gt 50) { "#dc3545" } elseif ($pctOfLibrary -gt 25) { "#ffc107" } else { "#00A0D9" }
...
function Invoke-SPOSecurityReport {
    ...
    Write-Host "     SharePoint Online Security & Usage Report Tool v3.1             " -ForegroundColor Cyan
    Write-Host "     $($Script:Branding.CompanyName) - $($Script:Branding.Tagline)                      " -ForegroundColor Cyan
    Write-Host "======================================================================" -ForegroundColor Cyan
    Write-Host ""
